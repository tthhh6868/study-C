...
//exp1 ? exp2 : exp3  //exp1成立运行exp2；exp1不成立运行exp3.



//typedef unsigned int u_int;//typedef重定义
//int main()
//{
//	unsigned int num1 = 0;
//	u_int num2 = 0;//两个类型一致
...
//void test()
//{
//	static int i = 0;  //static修饰局部变量；改变了变量的生命周期，让静态局部变量出了作用域依然存在，到程序结束，生命周期才结束
//	i++;
//	printf("%d\n", i);
//}
// 
...
//static修饰函数；一个函数被static修饰，使得这个函数只能在本源文件内使用，不能在其他源文件内使用。

//#define定义常变量和宏
//#define add(x,y)(x + y)//宏，注意后面是否有括号，有无决定着运算方式不同
//int main()
//{
//	int num1 = add(2,3);
//	printf("%d\n", num1);
